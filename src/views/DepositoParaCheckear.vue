<template>
	<div>
		...
		<!--
			...
			(modulo 'deposito' en created(), filtrado por to_check/confirmed en
			sales_to_show()). Mismo defecto que por-entregar/ventas/Index.vue: sin la prop,
			runListadoPorDefecto del grupo 221 corre igual apenas monta y pisa el listado
			scopeado con el general de ventas terminadas. Sin arreglar aca desde el
			25/7/2026.
		-->
		<view-component
